document.addEventListener('DOMContentLoaded', () => {
    ...
    function limpiarCampos() {
        ...
        document.getElementById('cargarArticulos').value = ""; // Limpiar selección de artículo
    }
    ...
    document.getElementById('agregaritem')?.addEventListener('click', (event) => {
        ...
        const cantidadi = parseFloat(document.getElementById('cantidadi').value) || 1;
    ...
    // Ordenar los resultados x meses
